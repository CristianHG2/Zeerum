...
var handler = Plaid.create({
  ...
  env: 'sandbox',
  key: '3fb9c06633f844357e6b2e42dc10c2', // Replace with your public_key to test with live credentials
  product: ['auth', 'transactions'],
  webhook: 'http://cherrera.me/budget/hook.php', // Optional – use webhooks to get transaction and error updates
